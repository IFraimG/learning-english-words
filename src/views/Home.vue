          ...
          <main class="main__form">
            <div ref="leftForm" class="main__form-left">
              ...
              <p>
                ...
                Voluptate nihil ducimus nesciunt, enim rem modi illum sed ipsa
                possimus earum ipsam quae dolorem quia. Suscipit mollitia
                distinctio aliquid autem fugit?
              </p>
            </div>
            <div class="main__form-right">
              ...
              <form
                class="main__registration main__auth"
                v-show="!loginInfo"
              ...
              >
                ...
                />
                <button type="submit" class="profile__run">
                  Зарегистрироваться
                </button>
              </form>
              <form
                class="main__login main__auth"
                v-show="loginInfo"
              ...
              >
                ...
                <input
                  ...
                  placeholder="Введите ваш пароль"
                />
                <p v-if="!isPassword" @click="isPassword = !isPassword">
                  Показать пароль
                </p>
          ...
          <div class="main__card">
            ...
            <div class="main__card__text">
              ...
              <p>
                ...
                dolor sapiente, facilis exercitationem blanditiis iste?
              </p>
            </div>
          </div>
          <div class="main__card">
  ...
  methods: {
    ...
    checkTransition() {
      setTimeout(() => {
        ...
        if (
          pageYOffset > offsetTop - itemPoint &&
          pageYOffset < offsetTop + elementHeight
        ) {
